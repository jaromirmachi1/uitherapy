...
export function RingStatementSection() {
  ...
  return (
    <section
      ...
      className="site-block relative isolate min-h-[calc(100svh-3rem)] overflow-hidden"
    >
      ...
      <div className="relative z-10 mx-auto flex min-h-[calc(100svh-3rem)] w-full max-w-[72rem] flex-col items-center justify-center px-4 py-24 text-center sm:px-8 sm:py-28">
        <motion.ul
